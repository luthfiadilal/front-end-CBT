        ...
        <div className="space-y-8 p-1">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">Kelola data seluruh pengguna sistem CBT</p>
                </div>
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-3 bg-white px-4 py-2.5 rounded-xl border border-gray-200 shadow-sm">
                        <div className="p-2 bg-green-50 rounded-lg">
                            <Icon icon="solar:users-group-rounded-bold" className="w-5 h-5 text-green-600" />
                        </div>
                        <div>
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 bg-gray-900 hover:bg-gray-800 text-white px-5 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-0.5"
                    >
